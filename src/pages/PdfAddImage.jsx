...
import { ChevronLeft, ChevronRight, FileOutput, Image as ImageIcon, X } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                {!file && (
                    <div className="max-w-xl mx-auto">
                        <FileUploader onFileSelect={handleFile} accept="application/pdf,.pdf" label="Upload PDF to Add Images" />
                    </div>
                )}
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-start">
                        ...
                        <div className="w-full lg:w-1/3 space-y-6">
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow border border-gray-100 dark:border-slate-700 text-center">
                                ...
                                <label htmlFor="img-upload" className="cursor-pointer flex flex-col items-center justify-center p-8 border-2 border-dashed border-purple-200 dark:border-purple-900/50 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-xl transition-colors">
                                    <ImageIcon size={40} className="text-purple-400 mb-2" />
                                    <span className="font-bold text-purple-600 dark:text-purple-400">Upload Image</span>
                            ...
                            <button onClick={downloadPdf} disabled={images.length === 0} className="w-full py-4 bg-purple-600 text-white font-bold rounded-2xl shadow-xl hover:bg-purple-700 disabled:opacity-50 transition-all active:scale-[0.98] flex items-center justify-center gap-2">
